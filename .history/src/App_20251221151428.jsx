...
### ⚙️ System Tampering
Observed  EXEC  calls attempting to overwrite cron jobs for periodic execution:/1root /.mod 
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              {['Features', 'Architecture', 'Demo', 'Blog', 'About'].map((item) => (
                <button
                  key={item}
    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden bg-black">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="inline-flex items-center px-4 py-2 rounded-full border border-green-500/30 bg-green-500/10 text-green-400 mb-8 animate-pulse">
          ...
          New Release: MirrorShield v1.0 - Now with Multi-Architecture Support!
        </div>
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-gray-900/50 border border-gray-800 p-8 rounded-2xl backdrop-blur-sm">
          <div className="space-y-6 text-gray-300 leading-relaxed text-lg">
            <p>
              This work was supported by the <span className="text-green-400 font-medium">Special Funds for the Cultivation of Guangdong College Students Scientific and Technological Innovation</span> (Grant No. pdjh2026c11106).
            </p>
            
            <p>
              We extend our sincere gratitude to <span className="text-white font-medium">Professor Hugh Anderson</span> and the "Defence Against the Dark Arts" summer workshop at the <span className="text-white font-medium">National University of Singapore</span>, where the initial concept and the prototype were conceived.
            </p>
            
            <p>
              We also thank our teammates from the <span className="text-white font-medium">QEMU-guardian project</span> for their foundational contributions.
            </p>
            
            <p>
              Special thanks go to the seniors at <span className="text-white font-medium">SUSTech Compass Lab</span> for their valuable guidance and technical support.
            </p>
            
            <p>
              Finally, we acknowledge the <span className="text-white font-medium">CS315 Computer Security course at SUSTech</span>, which provided the essential platform to develop the full system and complete this paper.
            </p>
          </div>
        </div>
      </div>
